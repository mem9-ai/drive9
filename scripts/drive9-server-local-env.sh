...
echo "  make run-server-local"
echo "  # verify_local_audio_extract.py asserts stub-shaped transcripts (expected_stub_transcript). With a real ASR,"
echo "  # content_text differs—use the script only for manual checks, or change assertions / add a flag before relying on exit 0."
