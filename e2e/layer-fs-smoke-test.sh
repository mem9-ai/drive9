...
base_local="$(drive9_e2e_tmp_path "drive9-layer-base-${ts}.txt")"
delete_local="$(drive9_e2e_tmp_path "drive9-layer-delete-${ts}.txt")"
rename_local="$(drive9_e2e_tmp_path "drive9-layer-rename-${ts}.txt")"
conflict_local="$(drive9_e2e_tmp_path "drive9-layer-conflict-${ts}.txt")"
conflict_mutated_local="$(drive9_e2e_tmp_path "drive9-layer-conflict-mutated-${ts}.txt")"
...
cli_small_local="$(drive9_e2e_tmp_path "drive9-layer-cli-small-${ts}.txt")"
cli_large_local="$(drive9_e2e_tmp_path "drive9-layer-cli-large-${ts}.bin")"
cli_large_download="$(drive9_e2e_tmp_path "drive9-layer-cli-large-downloaded-${ts}.bin")"
...
if require_layer_fuse_prereqs; then
  ...
  fuse_base_local="$(drive9_e2e_tmp_path "drive9-layer-fuse-base-${ts}.txt")"
  fuse_delete_local="$(drive9_e2e_tmp_path "drive9-layer-fuse-delete-${ts}.txt")"
  fuse_move_local="$(drive9_e2e_tmp_path "drive9-layer-fuse-move-${ts}.txt")"
  ...
  local_a="$(drive9_e2e_tmp_path "drive9-layer-local-a-${ts}")"
  log_a="$(drive9_e2e_tmp_path "drive9-layer-a-${ts}.log")"
  ...
  local_mismatch="$(drive9_e2e_tmp_path "drive9-layer-local-mismatch-${ts}")"
  log_mismatch="$(drive9_e2e_tmp_path "drive9-layer-mismatch-${ts}.log")"
  ...
  local_b="$(drive9_e2e_tmp_path "drive9-layer-local-b-${ts}")"
  log_b="$(drive9_e2e_tmp_path "drive9-layer-b-${ts}.log")"
  ...
  local_c="$(drive9_e2e_tmp_path "drive9-layer-local-c-${ts}")"
  log_c="$(drive9_e2e_tmp_path "drive9-layer-c-${ts}.log")"
