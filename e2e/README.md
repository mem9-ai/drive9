...
| `fuse-concurrency-stress.sh` | Real writable FUSE concurrency workload with explicit `--durability=write-sync`, parallel writers/readers, atomic rename, unlink churn, open-handle rename reads, and deterministic final manifest checks |
