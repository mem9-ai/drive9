...
func initDatastoreSchema(t *testing.T, dsn string) {
	...
	// Keep the MySQL fixture aligned with the runtime store shape: db9 and TiDB
	// providers all expose files.content_blob, while SmallInDB only controls the
	// preferred storage path for small files.
