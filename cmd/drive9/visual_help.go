	...
	return []visualHelpCommand{
		...
		},
		{
			...
			Flags: []visualHelpFlag{
				...
				{Name: "--max-media-llm-files N", Desc: "set-quota: max media LLM extract files; requires media extract config"},
				{Name: "--max-video-llm-files N", Desc: "set-quota: max video LLM extract files; requires video extract config"},
