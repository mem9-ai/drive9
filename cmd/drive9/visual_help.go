		...
		},
		{
			...
			Sections: []visualHelpSection{
				{Title: "Connection", Flags: []visualHelpFlag{
					...
					{Name: "--legacy-interruptible-mutations", Desc: "let FUSE interrupts cancel in-flight remote namespace-mutation commits (legacy EAGAIN behavior); env DRIVE9_MOUNT_LEGACY_INTERRUPTIBLE_MUTATIONS"},
				}},
