		...
		},
		{
			...
			Sections: []visualHelpSection{
				...
				{Title: "Overlay profiles", Flags: []visualHelpFlag{
					...
					{Name: "--local-only-gitignore-aware", Desc: "overlay a local-only path only when the repository also ignores it (default true; set false to overlay unconditionally)"},
